document.addEventListener('DOMContentLoaded', ()=>{
    document.querySelectorAll('plane').forEach(trigger => {
...
if(!useNativeScroll) {
    ...
    const displacementFs = `
        ...
        void main() {
            ...
            vec4 rTexture = texture2D(uRenderTexture, distortedCoords + flowTexture.xy * 0.000000125);
            vec4 gTexture = texture2D(uRenderTexture, distortedCoords);
            vec4 bTexture = texture2D(uRenderTexture, distortedCoords - flowTexture.xy * 0.000000125);
